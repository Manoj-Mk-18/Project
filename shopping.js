...
const Myhome = () =>{
    ...
    return(
        ...
        <div className="carousel-inner">
            ...
            <img src="img5.jpg" className="d-block w-100" height="400" alt="..."/>
            ...
            <img src="img9.jpg" className="d-block w-100" height="400" alt="..."/>
            <div className="carousel-caption d-none d-md-block">
            ...
            <div className="carousel-item">
            <img src="img6.jpg" className="d-block w-100"  height="400" alt="..."/>
            <div className="carousel-caption d-none d-md-block">
